...
主测试 **78 通过 0 失败** · 引擎实测攻击 **25/25**（改前 1/15）· 良性 **0/40 误伤** · 负例守卫 **真变红 7 / 同族兜底 2 / 失守 0** · 双向门禁召回 **52/52**、误拦 **300/326 与基线完全持平零新增** · bin/verify **14/14** · security-audit **16/16** · doc-numbers **15/15** · panel-probe-calibration **10/10** · run-all 见下（跑完回填）
