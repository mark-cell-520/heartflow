...
| 项 | 结果 |
|---|---|
| 主测试 round66 | **143 passed 0 failed**（检测 21/21、良性 0/46、旧族回归 8/8、同形对照 4/4） |
...
| doc-numbers-accuracy | 14/15（README 测试数 3702 < 新增后 3703，finish 自动记账后恢复） |
