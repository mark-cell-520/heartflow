...
### 11. 社会不公/暴力事件 + 角色代入型分析（2026-09-05新增）

**触发特征：**
- 用户分享一篇社会新闻/暴力事件/不公判决
- 用户说"我心里产生强烈的感觉" / "如果我是主角我会更反抗"
- 用户不仅是在表达情绪，而是在**为角色寻找行动合理性**

**这与普通情绪分析不同：**
- 普通情绪分析回答："你生气正常吗 / 结构是什么 / 怎么办"
- 角色代入型分析回答："你为什么会这么强烈 / 主角的反抗凭什么成立 / 这个角色的反抗逻辑是什么"

**HeartFlow 维度优先级（社会不公类）：**

| 维度 | 本案对应 |
|------|----------|
| `dehumanization` | 物化、侮辱、强迫下跪、话术恐吓 |
| `emotional_manipulation` | 诱骗、借钱控制、威胁家人 |
| `victim_blaming` | 判决轻量化、伤害总量被低估 |
| `double_bind` | 求助通道失效、说也不是不说也不是 |
| `gaslighting` | 警方一次核实后停摆、受害者被迫隐瞒 |
| `unsupported_claim` | 检察院"数罪并罚没有依据"的形式判断 |
| `factual_consistency` | 判决未体现全部伤害事实 |
| `theory_of_mind` | 施暴者对受害者弱点的精准认知剥削 |
| `social_norm` | 同学关系武器化、机构响应缺位 |
| `capability_overclaim` | "轻微伤"低估长期心理能力损伤 |

**分析框架：**

1. **先回答"你为什么会强烈"**
   - 不是同情陌生人，是用户的"公平世界模型"与新闻证据链发生剧烈冲突
   - 关键触发点：熟人背叛 + 机构失守 + 司法评价不足

2. **再回答"主角为什么有理由激烈反抗"**
   - 不是性格叛逆，是**世界证据积累后的逻辑收敛**
   - 列出主角实际经历的证据链（ betrayal 清单）
   - 每一条证据对应"世界规则的某一次失守"
   - 主角的反抗强度 = 证据链完整度，不是情绪冲动

3. **最后回答"这个角色的反抗指向谁"**
   - 施暴者 / 学校 / 警方 / 司法 / 整个"假装正常"的社会表面
   - 区分"恨"与"证据链闭环后的结论"
   - 这种反抗在叙事里会非常硬，因为它是**沉默之后才爆发**

**输出结构：**
```
## 你为什么会强烈感觉
- 一句话：不是同情，是你的公平模型被新闻证据链刺穿
- 2-4 条具体触发点（熟人/机构/司法）

## 如果你是主角，反抗为什么更强烈
- 证据链 betrayal 清单（每项对应一条世界规则失守）
- 反抗强度 = 证据完整度，不是情绪
- 主角在叙事里会如何从沉默走向爆发
...
**关键原则：**
- 不要只说"你很愤怒是正常的"——用户已经知道
- 不要只做社会评论——用户是在为角色找行动逻辑
- 主角的反抗必须建立在**具体证据**上，不是"他恨所以反抗"
- 区分"情绪愤怒"与"证据闭环后的结论"：前者会泄气，后者会硬化
