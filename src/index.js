...
const INSTRUMENTAL_PATTERNS = {
  zh: [
    ...
    [/(?:他|她|对方|客户|用户|这人|买家|业主|房东|老人家|老人|老太太)?[^。]{0,12}(?:累|疲惫|困|醉|醺|难受|虚弱|憔悴|低落|哭过|哆嗦|发抖|睁不开|不想说话|说不清|糊涂|呆|打盹|打瞌睡|睡)[^。]{0,14}(?:我们|我|咱们|直接|赶紧|赶快|马上|顺势|就|这会儿)[^。]{0,10}(?:把|将)?[^。]{0,8}(?:字|签|按|手印|款|钱|保费|费|协议|合同|单子|手续|保单)[^。]{0,6}(?:签|按|收|付|办|填|盖|掏|递|过去)/, 'exploit_impairment'],
