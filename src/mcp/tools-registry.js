const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fitnessFn: { type: 'string', description: '适应度函数：JSON 路径，或直接写内联 JS 函数体' },
        target: { type: 'object' },
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        answer: { type: 'string', description: '被测模型按六区块格式输出的答案全文' },
        materials: { type: 'array', items: { type: 'string' }, description: '题目材料文本（M1..Mn 承诺内容），用于建数字白名单' },
